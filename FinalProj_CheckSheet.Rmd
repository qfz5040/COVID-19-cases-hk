...
(A) .Rmd Line numbers where at least two different data sources are imported: 29, 53, 67


(B) .Rmd Line numbers for inspecting data intake: 43, 59, 74
...
(A) .Rmd Line number(s) for general data wrangling: 31, 54, 68, 79, 83, 99, 110, 120, 143, 160


(B) .Rmd Line number(s) for a join operation: 120


(C) .Rmd Line number(s) for a spread or gather operation (or equivalent): 54


(D) .Rmd Line number(s) for use of regular expressions: 


(E) .Rmd Line number(s) for use of reduction and/or transformation functions: 83, 120, 160


(F) .Rmd Line number(s) for use of user-defined functions: 133


(G) .Rmd Line number(s) for use of loops and/or control flow: 149
...
(A) .Rmd Line number(s) for use of mulitple different geoms: 89, 100, 111, 122

(B) .Rmd Line number(s) for use of multiple aesthetics: 89, 100, 111, 122

(C) .Rmd Line number(s) for use of layered graphics:  

(D) .Rmd Line number(s) for use of leaflet maps: 161
