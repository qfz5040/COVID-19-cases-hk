...
(A) .Rmd Line numbers where at least two different data sources are imported: 28, 51, 63


(B) .Rmd Line numbers for inspecting data intake: 41, 57, 70
...
(A) .Rmd Line number(s) for general data wrangling: 29, 52, 64, 79, 84, 95, 106, 116, 139, 156


(B) .Rmd Line number(s) for a join operation: 117


(C) .Rmd Line number(s) for a spread or gather operation (or equivalent): 52


(D) .Rmd Line number(s) for use of regular expressions: 


(E) .Rmd Line number(s) for use of reduction and/or transformation functions: 79, 116, 156


(F) .Rmd Line number(s) for use of user-defined functions: 129


(G) .Rmd Line number(s) for use of loops and/or control flow: 145
...
(A) .Rmd Line number(s) for use of mulitple different geoms: 85, 96, 107, 118

(B) .Rmd Line number(s) for use of multiple aesthetics: 85, 96, 107, 118

(C) .Rmd Line number(s) for use of layered graphics:  

(D) .Rmd Line number(s) for use of leaflet maps: 157
